    ...
    >
      <Stack gap="md">
        <SegmentedControl
          fullWidth
          value={mode}
          onChange={(value) => setMode(value as "quick" | "wizard")}
          data={[
            { value: "wizard", label: "Průvodce krok za krokem" },
            { value: "quick", label: "Rychlé nastavení" },
          ]}
        />
        ...
        {mode === "quick" ? (
          ...
          <RedirectWizard karenNumber={karenNumber || ""} onComplete={onClose} />
        )}
      </Stack>
    </Modal>
  );
